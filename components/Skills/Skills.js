        ...
        <div className="bg-white w-full">
            <div className="py-24 flex-1 xl:container mx-auto">
                <h1 className="text-4xl text-center ">
                    <span className="text-secondary-color font-semibold">Skills</span> &{" "}
                    <span className="text-secondary-color font-semibold">Experience</span>
                </h1>

                <div className=" lg:flex lg:justify-center p-12 gap-14 ">
                    <div className=" flex-[3]  flex flex-wrap gap-10 justify-center items-center bg-primary-color p-4 rounded shadow">
                        {skills.map((item, index) => (
                            <motion.div key={index} className="flex flex-col items-center gap-2">
                                ...
                                >
                                    <Image src={item.img} width={45} height={45} objectFit="contain" alt="img" />
                                </motion.div>
